...
// TODO: Replace with NPC collection address
const NPC_COLLECTION_ADDRESS = "0x0000000000000000000000000000000000000000" as `0x${string}`;
      ...
      {metadata?.image && (
        <Link href={`/collage/${gridId.toString()}`}>
          ...
          >
            <img
              src={metadata.image}
              alt={metadata.name || `NPC Grid #${gridId}`}
              style={{
                width: "100%",
                height: "100%",
                objectFit: "contain",
...
export default function NPCGridsPage() {
  ...
  // TODO: Implement NFT fetching for NPC collection
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        {activeTab === "create" && (
          <div>
            ...
            {/* TODO: Implement NPC NFT fetching and display */}
            <div style={{ marginBottom: "80px", paddingBottom: "40px" }}>
              ...
              >
                Your NPC NFTs ({ownedNFTs.length})
              </h3>
              <div style={{ padding: "20px", color: "#666666", textAlign: "center" }}>
                NPC collection integration coming soon
              </div>
            </div>
        ...
        {activeTab === "my-grids" && (
          <div>
            ...
            {loadingGrids ? (
              ...
              >
                <p style={{ fontSize: "18px", marginBottom: "10px" }}>No NPC grids yet</p>

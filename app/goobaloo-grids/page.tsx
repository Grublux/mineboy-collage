...
// CollageCard component for displaying minted Goobaloo grids
  ...
  return (
    ...
    >
      {metadata?.image && (
        <Link href={`/collage/${collageId.toString()}`}>
          ...
          >
            <img
              src={metadata.image}
              alt={metadata.name || `Goobaloo Grid #${collageId}`}
              style={{
                width: "100%",
                height: "100%",
                objectFit: "contain",
      ...
      <div>
        ...
        >
          {metadata?.name || `Goobaloo Grid #${collageId}`}
        </h3>
...
export default function MyCollagesPage() {
  ...
  // State for Create Goobaloo Grid tab
      ...
      >
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              To View and create Goobaloo grids
            </p>
          </div>
        </div>
      </div>
    ...
    >
      <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: "10px", marginBottom: "30px", borderBottom: "2px solid #333333" }}>
          ...
          >
            My Goobaloo Grids ({collageBalanceNum})
          </button>
        </div>

        {/* Create Goobaloo Grid Tab */}
        {activeTab === "create" && (
          <div>
            <h2
              style={{

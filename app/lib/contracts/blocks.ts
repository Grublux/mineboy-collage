...
export const blockHubConfig = {
  ...
  abi: [
    ...
    {
      type: "function",
      name: "setGlobalRootCreationOpen",
    ...
    },
    {
      type: "function",
      name: "setPriceETH",
      inputs: [{ name: "rootId", type: "uint256" }, { name: "price", type: "uint256" }],
      outputs: [],
      stateMutability: "nonpayable",
    },
    {
      type: "function",
      name: "setPrice20",
      inputs: [{ name: "rootId", type: "uint256" }, { name: "token", type: "address" }, { name: "price", type: "uint256" }],
      outputs: [],
      stateMutability: "nonpayable",
    },
    {
      type: "function",
      name: "setAllowed20",
      inputs: [{ name: "rootId", type: "uint256" }, { name: "token", type: "address" }, { name: "allowed", type: "bool" }],
      outputs: [],
      stateMutability: "nonpayable",
    },
    {
      ...
      inputs: [
        ...
        { name: "lockDur", type: "uint32" },
        { name: "coolDur", type: "uint32" },
      ],
      outputs: [{ name: "", type: "uint256" }],
      stateMutability: "nonpayable",
    },
    {
      ...
      inputs: [{ name: "rootId", type: "uint256" }, { name: "scheduleId", type: "uint256" }, { name: "active", type: "bool" }],
      outputs: [],
      stateMutability: "nonpayable",
    },
    {

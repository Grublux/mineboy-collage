...
async function checkAllowance() {
  ...
  try {
    ...
    if (allowance < PRICE) {
      console.log('\n⚠️  ISSUE: NGT allowance is insufficient!');
      console.log('   You need to approve NGT again. The approval may have expired or been reset.');
      console.log('   Approve amount: 3333 NGT (or use max uint256 for permanent approval)');
    }
  } catch (err) {
